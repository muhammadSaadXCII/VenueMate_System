...
class UserComplaintDetailsScreen extends StatelessWidget {
  ...
  final bool inlineMode; // Added for Web Responsiveness
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, snap) {
                                ...
                                children: [
                                  ...
                                  Text(
                                    adminResponse.isNotEmpty
                                        ? adminResponse
                                        : 'Your complaint is being reviewed. We will get back to you shortly.',
                                    style: const TextStyle(
                                      fontSize: 13,
                                      color: Colors.black87,
                                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'Your complaint is pending review. Our team will respond shortly.',
                              style: TextStyle(
                                fontSize: 13,
        ...
        if (inlineMode) return bodyContent;
