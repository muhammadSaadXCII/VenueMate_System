...
class _RejectRegistrationScreenState extends State<RejectRegistrationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Submit button (shared between mobile bottom nav and web inline button)
    ...
    Widget formBody = Column(
      ...
      children: [
        ...
        Center(
          child: Text(
            'The hall owner will see this reason and must correct it before re-submitting.',
            textAlign: TextAlign.center,
            style: TextStyle(
              fontSize: 13,
        ...
        // "Another reason" expandable text field
        AnimatedContainer(
        ...
        // On web, submit button is inline at the bottom of the form
        if (isWide) ...[
    ...
    if (isWide) {
      // ── Web layout: centered card, no bottomNavigationBar ─────────────
      return Scaffold(
    ...
    // ── Mobile layout: original with bottomNavigationBar ─────────────────
    return Scaffold(
      backgroundColor: Colors.white,
      appBar: AppBar(
        backgroundColor: Colors.white,
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color:
                    isSelected ? const Color(0xFFD92D20) : Colors.transparent,
                border: Border.all(
                  color:
                      isSelected
